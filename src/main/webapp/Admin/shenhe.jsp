						...
						<tbody>
							<c:forEach var="htmx" items="${list}" varStatus="a">
								<tr class="text-c odd" role="row">
									...
									<td name="receivedMoney" id="${htmx.roomPayId }receivedMoney">${htmx.receivedMoney}</td>
									<td name="uncollectedMoney" id="${htmx.roomPayId }uncollectedMoney">${htmx.uncollectedMoney }</td>
									<td name="deleteState" id="${htmx.roomPayId }deleteState"><a href="shenhe.do?roomPayId=${htmx.roomPayId }">通过</a>|<a href="butongguo.do?roomPayId=${htmx.roomPayId }">不通过</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
