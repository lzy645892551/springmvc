...
<link rel="stylesheet" type="text/css" href="secondCSS/skin.css"
	id="skin">
...
<body>
	<article class="page-container">
		<form action="update.do" name="form" method="post"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="createTime" style="width:350px;"
						readonly="readonly" id="createTime"
						class="input-text Wdate" value="${time}">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${order.customerName}"
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="sel"
						name="roomId" onchange="gradeChange()">
						 <option value ="${order.roomId}">${ht.roomCode}</option>
						<c:forEach items="${list1}" var="dd">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${order.payArea}"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${order.unitPrice}"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${order.total}"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
						...
						<option value="${order.payTypeName}">${order.payTypeName}</option>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>订单类型：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${order.orderType}" 
						placeholder="" id="orderType" name="orderType">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
						<select class="input-text" style="width:350px;" id="name" name="name" >
	...
	<script type="text/javascript" src="secondCSS/jquery.icheck.min.js"></script>
	...
	<script type="text/javascript" src="secondCSS/jquery.validate.min.js"></script>
	<script type="text/javascript" src="secondCSS/validate-methods.js"></script>
	<script type="text/javascript" src="secondCSS/messages_zh.min.js"></script>
	...
	<script type="text/javascript" src="secondCSS/jquery-ui.css"></script>
	<script type="text/javascript" src="secondCSS/jquery-ui.js"></script>

	<script type="text/javascript">
	 function sub(){
	 	var deleteState = document.getElementById("deleteState").value;
