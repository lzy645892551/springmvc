...
<body>
	...
	<button class="btn btn-primary radius" onclick="huifu()">恢复</button>
						...
						<tbody>
							<c:forEach var="htmx" items="${list}">
								<tr class="text-c odd" role="row">
									...
									<td class="ybox06td03bcenter"><span class="l">  <a class="btn btn-primary radius" onClick="system_category_add('修改订单信息','selbyid.do?orderId=${htmx.orderId}')" href="javascript:;">查看/修改</a></span> <a class="btn btn-primary radius" href="del.do?orderId=${htmx.orderId}" />删除</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
