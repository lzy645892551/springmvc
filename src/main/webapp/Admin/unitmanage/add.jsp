		...
		<form action="add.do" name="form" method="post"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="project"
						name="project.projectId" onchange="gradeChange()">
						<c:if test="${unit != null}">
							<option value="${unit.build.project.projectId }">${unit.build.project.projectName }</option>
						</c:if>
						<c:if test="${unit == null }">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>所属楼栋</label>
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="build"
						name="build.buildId" onchange="buildchange()">
						<c:if test="${unit != null}">
							<option value="${unit.build.buildId }">${unit.build.buildName }</option>
						</c:if>
						<c:if test="${unit == null }">
							<option value="">-------请选择-------</option>
						</c:if>
						<c:forEach items="${builist}" var="p">
							<option value="${p.buildId}" >${p.buildName}</option>
						</c:forEach>
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="unitCode"
						name="unitCode" >
						<c:if test="${unit != null}">
						...
						<c:forEach varStatus="i" begin="1" end="10">
							<c:if test="${isDone == 0 }">
								...
								<c:if test="${i.count > unit.build.roomCount }">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>房间数量</label>
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="roomCount" name="roomCount"> 
						<c:if test="${unit != null}">
							<option value="${unit.roomCount }">${unit.roomCount }</option>
						</c:if>
						<c:if test="${unit == null }">
							<option value="">-------请选择-------</option>
						</c:if>
