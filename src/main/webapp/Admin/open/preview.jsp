				...
				<tr>
					...
					<td><table border="0" cellspacing="0" cellpadding="0">
							<tr valign="top">
								...
								<td class="ybox11td6"><a href="#">6、预览并提交</a></td>
								<td class="ybox11td9"></td>
					...
					<td class="ybox03td5"><div class="ybox05 margb8">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								...
								<input name="project.projectId" id="project.projectId" readonly="readonly" style="width:180px;" value="${open.project.projectName }" />
								...
								<td width="15%" class="ybox04tdl"><span class="red">*</span>
									报告名称</td>
								<td width="18%" class="ybox04tdr">
								<c:if test="${open.discount == null }">
									<input style="width:180px;" id="openingReportName" name="openingReportName" value="${open.openingReportName }" />
								</c:if>
								<c:if test="${open.discount != null }">
									<input style="width:180px;" id="openingReportName" readonly="readonly" name="openingReportName" value="${open.openingReportName }" />
								</c:if>
								</td>
								<td width="15%" class="ybox04tdl"><span class="red">*</span>
									报告类型</td>
							...
							<tr>
								...
								<td class="ybox04tdr" name="updateTime"><input type="hidden" name="updateTime"  />
								<fmt:formatDate  value="${open.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							...
							<tr>
								...
								<td class="ybox04tdr" name="openingReportTime"><input type="hidden" name="openingReportTime"  />
								<fmt:formatDate value="${open.openingReportTime}" pattern="yyyy-MM-dd 08:00:00"/></td>
							...
							<tr>
								...
								<td colspan="5" class="ybox04tdr">
									<c:if test="${open.priceType == 1 }">
										<label> 
										<input type="radio" 
											name="priceType" id="RadioGroup1" value="1" checked="checked" /> 建筑面积
										</label> &nbsp;&nbsp; 
									...
									<c:if test="${open.priceType == 2 }">
										...
										<label> <input type="radio"
											name="priceType" id="RadioGroup1" value="2" checked="checked" /> 套内面积
										</label> &nbsp;&nbsp;
									</c:if>
...
${open.openingReportDescription }
			...
			<table width="380" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td height="60" align="center"><a href="submit.do"><img
