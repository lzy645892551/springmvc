...
<body>
		...
		<form action="add.do" name="form" method="post"
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>付款方式名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${payType.payTypeName }"
						placeholder="" id="payTypeName" name="payTypeName">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>试用对象：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${payType.applyScope }"
						placeholder="" id="applyScope" name="applyScope">
				</div>
			</div>

			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>付款方式类型：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="payTypeKind"
						name="payTypeKind" >
						<option value="${payType.payTypeKind }">${payType.payTypeKind }</option>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>百分比：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${payType.explains }"
						placeholder="" id="explains" name="explains" onkeydown="zhekou()">
				</div>
			</div>

			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">折扣：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${payType.discount }"
						placeholder="" id="discount" name="discount" readonly="readonly">
				</div>
			</div>
	...
	function zhekou(){
		...
		var zhekou = (1-explains/100).toFixed(2);
	 ...
	 function sub(){
		...
		var applyScope = document.getElementById("applyScope").value;
		var payTypeKind = document.getElementById("payTypeKind").value;
		var explains = document.getElementById("explains").value;
		...
		if(explains>150){
	 	...
	 	$.ajax({
				url : "../fukuan/update.do",
				data : {
					"payTypeId" : payTypeId,
					"payTypeName" : payTypeName,
					"applyScope" : applyScope,
					"payTypeKind" : payTypeKind,
					"explains" : explains,
					"discount" : discount,
				},
				dataType : "text",
