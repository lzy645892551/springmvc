...
<body>
	<article class="page-container">
		<form action="add.do" name="form" method="post"
			...
			<input type="hidden" id="saleChanceId" name="saleChanceId" value="${sal.saleChanceId }">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>机会名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${sal.saleChanceName }"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="projectId"
						...
						<option value="${sal.projectId }">${xiangmuname.projectName }</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="buildId"
						...
						<option value="${sal.buildId }">${loudong.buildName}</option>
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="unitId"
						...
						<option value="${sal.unitId }">${danyuan.unitCode }</option>
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="roomId"
						name="roomId">
						<option value="${sal.roomId }">${room.roomCode }</option>
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="customerName"
						...
						<option value="${sal.customerName }">${sal.customerName }</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${sal.tel }"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${sal.number }"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
						...
						name="userName" >
						<option value="${sal.userName }">${sal.userName }</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${sal.intentionDescription }"
	...
	<script type="text/javascript">
		...
		function sub() {
			var saleChanceId = document.getElementById("saleChanceId").value;
