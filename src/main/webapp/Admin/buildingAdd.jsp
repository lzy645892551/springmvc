...
<script type="text/javascript"> 
 ...
 function buildAdd(){
		var buildCount ="";
		var index=document.getElementById("projectId").selectedIndex;
		var projectName = document.getElementById("projectId").options[index].text;
		...
		if(document.getElementById("buildCount"))
			buildCount = document.getElementById("buildCount").value;
	 	$.ajax({
				url : "../build/buildAddOrUpdate.do",
				data : {
...
<article class="page-container">
	<form action="build/buildAddOrUpdate.do" name="form" method="post" class="form form-horizontal" id="form-member-add" onSubmit="return test()">
		<input type = "hidden" id = "updateUser" name = "updateUser" value = "${name}">
		<input type = "hidden" id = "selectProjectId" name = "selectProjectId" value = "${building.projectId}" />
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select type="text" class="input-text" style="width:350px;" value="" placeholder="" id="projectId" name="projectId">
		...
		<c:if test="${insertBatch!=null}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>楼栋数量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width:350px;" value="" placeholder="" id="buildCount" name="buildCount">
			</div>
		</div>
		</c:if>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width:350px;" value="${building.buildName }" placeholder="" id="buildName" name="buildName">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width:350px;" value="${building.floorCount}" placeholder=""  id="floorCount" name="floorCount">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width:350px;" value="${building.roomCount}" placeholder="" id="roomCount" name="roomCount">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width:350px;" value = "${building.remark}" placeholder="" name="remark" id = "remark">
			</div>
		</div>
