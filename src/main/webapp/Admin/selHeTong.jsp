		...
		<input type="hidden" name="contractId" id="contractId" value="${Contract.contractId }">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="signTime" style="width:350px;"
						onFocus="WdatePicker({maxDate:&#39;%y-%M-%d&#39;})" id="signTime"
						class="input-text Wdate" value = "${time}" readonly="readonly">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${Contract.customerName }"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
						...
						<option value="${Contract.payTypeName }">${Contract.payTypeName }</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="sel"
						...
						<option value="${Contract.roomId }">${ht.roomCode }</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${Contract.total }"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" value="${Contract.contractTotal }"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;"
						placeholder="" name="firstParty" id="firstParty" value="${Contract.firstParty }">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;"  
						placeholder="" id="secondParty" name="secondParty" value="${Contract.secondParty }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;" 
						placeholder="" id="contractContent" name="contractContent" value="${Contract.contractContent }">
				</div>
			</div>
