	...
	<article class="page-container">
		...
		<input type="hidden" name="deleteState" id="deleteState" value="0">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select class="input-text" style="width:350px;" id="customerName" name="customerName">
						...
						<c:forEach items="${dingdanname}" var="dd">
							<option value="${dd.orderId}&${dd.customerName}">${dd.customerName}</option>
						</c:forEach>
					</select>
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
						<select class="input-text" style="width:350px;" id="payTypeName" name="payTypeName" onchange="aaa()">
						<option value="">-------请选择-------</option>
				...
				<input type="hidden" value="" name="zhekou" id="zhekou">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;"
						placeholder="" name="firstParty" id="firstParty">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" style="width:350px;"  
						placeholder="" id="secondParty" name="secondParty">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
 	...
 	function gradeChange(){
        ...
        $.ajax({
				...
				success : function(data) {
					...
					document.getElementById("contractTotal").value=ze*zhekou1;
				},
				error : function() {
				}
			}); 
       ...
       function aaa(){
		...
		$.ajax({
				...
				type : "post",
				success : function(data) {
					document.getElementById("zhekou").value=data;
				},
				error : function() {
					alert("有误！");
				}
