...
(function($, undefined) {
    ...
    $.ui.define('calendar', {
        ...
        _init: function() {
            ...
            /*setTimeout(function(){
                var _bodyHeight = document.body.scrollHeight;
                el.children('.ui-calendar-calendar').css({'height': _bodyHeight + 'px'});
            },1000);*/
        },
        ...
        refresh: function() {
            ...
            var _bodyHeight = document.body.scrollHeight;
            el.find('.ui-calendar-gap').remove();
            el.children('.ui-calendar-calendar').css({'height': (_bodyHeight - 36) + 'px'});
